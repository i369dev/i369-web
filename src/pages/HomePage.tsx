      ...
      <section id="hero-section" className="relative w-full border-b border-black flex flex-col overflow-hidden">
        <div className="flex-1 w-full min-h-[calc(100vh-5rem)] flex flex-col">
          ...
          <div className="w-full flex flex-col relative thin-grid bg-white text-[#141414] justify-between flex-grow">
            ...
            <div className="border-t border-black/15 flex flex-wrap items-center px-4 sm:px-8 md:px-12 lg:px-16 py-4 sm:py-6 gap-4 sm:gap-8 lg:gap-10 bg-white/70 backdrop-blur-md">
              <span className="text-[9px] sm:text-[10px] font-bold uppercase tracking-widest opacity-50 w-24 sm:w-28 shrink-0 font-mono-code">
                Trusted Partners
              </span>
              <div className="flex flex-wrap items-center gap-4 sm:gap-6 md:gap-8 grayscale opacity-80">
