        ...
        <div className="p-4 sm:p-8 md:p-9">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 sm:gap-4 pb-4 sm:pb-5 border-b border-black/10">
            ...
            <div className="flex flex-wrap gap-1.5">
              {pillar.tags.slice(0, 3).map((tag, tIdx) => (
                <span
                  key={tIdx}
                  className="px-2.5 py-1 text-[10px] font-mono-code uppercase tracking-wider border border-black/10 bg-zinc-100 text-zinc-700 rounded-full font-medium"
                >
                  {tag}
                </span>
              ))}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-5 sm:gap-6 lg:gap-8 pt-4 sm:pt-5 items-start">
            ...
            <div className="lg:col-span-6 space-y-3.5 sm:space-y-4">
              ...
              <p className="text-xs sm:text-sm md:text-[14px] text-zinc-700 font-normal leading-relaxed">
                {pillar.description}
              </p>
            ...
            <div className="lg:col-span-6 space-y-2 sm:space-y-2.5">
              ...
              <div className="space-y-2">
                {pillar.points.map((point, pIdx) => (
                  <div
                    key={pIdx}
                    className="p-2.5 sm:p-3 rounded-xl border border-black/10 bg-zinc-50/80 hover:bg-zinc-100 flex items-start gap-2.5 sm:gap-3 transition-colors duration-200"
                  >
                    <span 
